...
interface Odontologo {
  ...
  telefono: string;
  correo: string;
  // fechaNacimiento?: string; ❌ elimina si no está en la BD
  // genero?: string; ❌ elimina si no está en la BD
}
...
export class OdontologoComponent implements OnInit {
 ...
 formulario: FormGroup = this.fb.group({
  ...
  correo: ['', [Validators.required, Validators.email]],  // antes: email
  // Elimina estos campos porque no existen en la tabla
